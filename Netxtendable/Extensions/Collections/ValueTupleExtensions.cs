...
namespace Netxtendable.Extensions.Collections {
    ...
    public static class ValueTupleExtensions {
        ...
        /// </returns>
        public static IEnumerator<T> GetEnumerator<T>(this ValueTuple<T, T> t) {
        ...
        /// <see cref="IEnumerable{T}"/> with items of <paramref name="t"/>
        /// </returns>
        public static IEnumerator<T> GetEnumerator<T>(this ValueTuple<T, T, T> t) {
            yield return t.Item1;
            yield return t.Item2;
        ...
        /// <see cref="IEnumerable{T}"/> with items of <paramref name="t"/>
        /// </returns>
        public static IEnumerator<T> GetEnumerator<T>(this ValueTuple<T, T, T, T> t) {
            yield return t.Item1;
            yield return t.Item2;
            yield return t.Item3;
        ...
        /// <see cref="IEnumerable{T}"/> with items of <paramref name="t"/>
        /// </returns>
        public static IEnumerator<T> GetEnumerator<T>(this ValueTuple<T, T, T, T, T> t) {
            yield return t.Item1;
            yield return t.Item2;
            yield return t.Item3;
            yield return t.Item4;
        ...
        /// <see cref="IEnumerable{T}"/> with items of <paramref name="t"/>
        /// </returns>
        public static IEnumerator<T> GetEnumerator<T>(this ValueTuple<T, T, T, T, T, T> t) {
            yield return t.Item1;
            yield return t.Item2;
            yield return t.Item3;
            yield return t.Item4;
        ...
        /// <see cref="IEnumerable{T}"/> with items of <paramref name="t"/>
        /// </returns>
        public static IEnumerator<T> GetEnumerator<T>(this ValueTuple<T, T, T, T, T, T, T> t) {
            yield return t.Item1;
            yield return t.Item2;
            yield return t.Item3;
            yield return t.Item4;
