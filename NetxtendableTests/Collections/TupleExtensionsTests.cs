...
namespace Netxtendable.Collections.Tests {
    ...
    public class TupleExtensionsTests {
        ...
        public void Deconstruct_3_Test() {
            var (i1, i2, i3) = Tuple.Create(1, 2, 3);
            Assert.AreEqual(1, i1);
            Assert.AreEqual(2, i2);
            Assert.AreEqual(3, i3);
            var (s1, s2, s3) = Tuple.Create("1", "2", "3");
            Assert.AreEqual("1", s1);
            Assert.AreEqual("2", s2);
        ...
        public void Deconstruct_4_Test() {
            var (i1, i2, i3, i4) = Tuple.Create(1, 2, 3, 4);
            Assert.AreEqual(1, i1);
            Assert.AreEqual(2, i2);
            Assert.AreEqual(3, i3);
            Assert.AreEqual(4, i4);
            var (s1, s2, s3, s4) = Tuple.Create("1", "2", "3", "4");
            Assert.AreEqual("1", s1);
            Assert.AreEqual("2", s2);
            Assert.AreEqual("3", s3);
        ...
        public void Deconstruct_5_Test() {
            var (i1, i2, i3, i4, i5) = Tuple.Create(1, 2, 3, 4, 5);
            Assert.AreEqual(1, i1);
            Assert.AreEqual(2, i2);
            Assert.AreEqual(3, i3);
            Assert.AreEqual(4, i4);
            Assert.AreEqual(5, i5);
            var (s1, s2, s3, s4, s5) = Tuple.Create("1", "2", "3", "4", "5");
            Assert.AreEqual("1", s1);
            Assert.AreEqual("2", s2);
            Assert.AreEqual("3", s3);
            Assert.AreEqual("4", s4);
        ...
        public void Deconstruct_6_Test() {
            var (i1, i2, i3, i4, i5, i6) = Tuple.Create(1, 2, 3, 4, 5, 6);
            Assert.AreEqual(1, i1);
            Assert.AreEqual(2, i2);
            Assert.AreEqual(3, i3);
            Assert.AreEqual(4, i4);
            ...
            var (s1, s2, s3, s4, s5, s6) = Tuple.Create("1", "2", "3", "4", "5", "6");
            Assert.AreEqual("1", s1);
            Assert.AreEqual("2", s2);
            Assert.AreEqual("3", s3);
            Assert.AreEqual("4", s4);
        ...
        public void Deconstruct_7_Test() {
            var (i1, i2, i3, i4, i5, i6, i7) = Tuple.Create(1, 2, 3, 4, 5, 6, 7);
            Assert.AreEqual(1, i1);
            Assert.AreEqual(2, i2);
            Assert.AreEqual(3, i3);
            Assert.AreEqual(4, i4);
            ...
            var (s1, s2, s3, s4, s5, s6, s7) = Tuple.Create("1", "2", "3", "4", "5", "6", "7");
            Assert.AreEqual("1", s1);
            Assert.AreEqual("2", s2);
            Assert.AreEqual("3", s3);
            Assert.AreEqual("4", s4);
        ...
        public void ToArray_2_Test() {
            var ints = Tuple.Create(1, 2).ToArray();
            CollectionAssert.AreEqual(new[] { 1, 2 }, ints);
            var strings = Tuple.Create("1", "2").ToArray();
        ...
        public void ToArray_3_Test() {
            var ints = Tuple.Create(1, 2, 3).ToArray();
            CollectionAssert.AreEqual(new[] { 1, 2, 3 }, ints);
            var strings = Tuple.Create("1", "2", "3").ToArray();
        ...
        public void ToArray_4_Test() {
            var ints = Tuple.Create(1, 2, 3, 4).ToArray();
            CollectionAssert.AreEqual(new[] { 1, 2, 3, 4 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4").ToArray();
        ...
        public void ToArray_5_Test() {
            var ints = Tuple.Create(1, 2, 3, 4, 5).ToArray();
            CollectionAssert.AreEqual(new[] { 1, 2, 3, 4, 5 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4", "5").ToArray();
        ...
        public void ToArray_6_Test() {
            var ints = Tuple.Create(1, 2, 3, 4, 5, 6).ToArray();
            CollectionAssert.AreEqual(new[] { 1, 2, 3, 4, 5, 6 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4", "5", "6").ToArray();
        ...
        public void ToArray_7_Test() {
            var ints = Tuple.Create(1, 2, 3, 4, 5, 6, 7).ToArray();
            CollectionAssert.AreEqual(new[] { 1, 2, 3, 4, 5, 6, 7 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4", "5", "6", "7").ToArray();
        ...
        public void ToList_2_Test() {
            var ints = Tuple.Create(1, 2).ToList();
            CollectionAssert.AreEqual(new[] { 1, 2 }, ints);
            var strings = Tuple.Create("1", "2").ToList();
            CollectionAssert.AreEqual(new[] { "1", "2" }, strings);
            Assert.ThrowsException<ArgumentNullException>(() => {
        ...
        public void ToList_3_Test() {
            var ints = Tuple.Create(1, 2, 3).ToList();
            CollectionAssert.AreEqual(new[] { 1, 2, 3 }, ints);
            var strings = Tuple.Create("1", "2", "3").ToList();
            CollectionAssert.AreEqual(new[] { "1", "2", "3" }, strings);
            Assert.ThrowsException<ArgumentNullException>(() => {
        ...
        public void ToList_4_Test() {
            var ints = Tuple.Create(1, 2, 3, 4).ToList();
            CollectionAssert.AreEqual(new[] { 1, 2, 3, 4 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4").ToList();
            CollectionAssert.AreEqual(new[] { "1", "2", "3", "4" }, strings);
            Assert.ThrowsException<ArgumentNullException>(() => {
        ...
        public void ToList_5_Test() {
            var ints = Tuple.Create(1, 2, 3, 4, 5).ToList();
            CollectionAssert.AreEqual(new[] { 1, 2, 3, 4, 5 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4", "5").ToList();
            CollectionAssert.AreEqual(new[] { "1", "2", "3", "4", "5" }, strings);
            Assert.ThrowsException<ArgumentNullException>(() => {
        ...
        public void ToList_6_Test() {
            var ints = Tuple.Create(1, 2, 3, 4, 5, 6).ToList();
            CollectionAssert.AreEqual(new[] { 1, 2, 3, 4, 5, 6 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4", "5", "6").ToList();
            CollectionAssert.AreEqual(new[] { "1", "2", "3", "4", "5", "6" }, strings);
            Assert.ThrowsException<ArgumentNullException>(() => {
        ...
        public void ToList_7_Test() {
            var ints = Tuple.Create(1, 2, 3, 4, 5, 6, 7).ToList();
            CollectionAssert.AreEqual(new[] { 1, 2, 3, 4, 5, 6, 7 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4", "5", "6", "7").ToList();
            CollectionAssert.AreEqual(new[] { "1", "2", "3", "4", "5", "6", "7" }, strings);
            Assert.ThrowsException<ArgumentNullException>(() => {
        ...
        public void ToSet_2_Test() {
            var ints = Tuple.Create(1, 2).ToSet().ToArray();
            CollectionAssert.AreEquivalent(new[] { 1, 2 }, ints);
            var strings = Tuple.Create("1", "2").ToSet().ToArray();
        ...
        public void ToSet_3_Test() {
            var ints = Tuple.Create(1, 2, 3).ToSet().ToArray();
            CollectionAssert.AreEquivalent(new[] { 1, 2, 3 }, ints);
            var strings = Tuple.Create("1", "2", "3").ToSet().ToArray();
        ...
        public void ToSet_4_Test() {
            var ints = Tuple.Create(1, 2, 3, 4).ToSet().ToArray();
            CollectionAssert.AreEquivalent(new[] { 1, 2, 3, 4 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4").ToSet().ToArray();
        ...
        public void ToSet_5_Test() {
            var ints = Tuple.Create(1, 2, 3, 4, 5).ToSet().ToArray();
            CollectionAssert.AreEquivalent(new[] { 1, 2, 3, 4, 5 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4", "5").ToSet().ToArray();
        ...
        public void ToSet_6_Test() {
            var ints = Tuple.Create(1, 2, 3, 4, 5, 6).ToSet().ToArray();
            CollectionAssert.AreEquivalent(new[] { 1, 2, 3, 4, 5, 6 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4", "5", "6").ToSet().ToArray();
        ...
        public void ToSet_7_Test() {
            var ints = Tuple.Create(1, 2, 3, 4, 5, 6, 7).ToSet().ToArray();
            CollectionAssert.AreEquivalent(new[] { 1, 2, 3, 4, 5, 6, 7 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4", "5", "6", "7").ToSet().ToArray();
        ...
        public void Enumerate_2_Test() {
            var ints = Tuple.Create(1, 2).Enumerate().ToArray();
            CollectionAssert.AreEqual(new[] { 1, 2 }, ints);
            var strings = Tuple.Create("1", "2").Enumerate().ToArray();
            CollectionAssert.AreEqual(new[] { "1", "2" }, strings);
            Assert.ThrowsException<ArgumentNullException>(() => {
        ...
        public void Enumerate_3_Test() {
            var ints = Tuple.Create(1, 2, 3).Enumerate().ToArray();
            CollectionAssert.AreEqual(new[] { 1, 2, 3 }, ints);
            var strings = Tuple.Create("1", "2", "3").Enumerate().ToArray();
            CollectionAssert.AreEqual(new[] { "1", "2", "3" }, strings);
            Assert.ThrowsException<ArgumentNullException>(() => {
        ...
        public void Enumerate_4_Test() {
            var ints = Tuple.Create(1, 2, 3, 4).Enumerate().ToArray();
            CollectionAssert.AreEqual(new[] { 1, 2, 3, 4 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4").Enumerate().ToArray();
            CollectionAssert.AreEqual(new[] { "1", "2", "3", "4" }, strings);
            Assert.ThrowsException<ArgumentNullException>(() => {
        ...
        public void Enumerate_5_Test() {
            var ints = Tuple.Create(1, 2, 3, 4, 5).Enumerate().ToArray();
            CollectionAssert.AreEqual(new[] { 1, 2, 3, 4, 5 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4", "5").Enumerate().ToArray();
            CollectionAssert.AreEqual(new[] { "1", "2", "3", "4", "5" }, strings);
            Assert.ThrowsException<ArgumentNullException>(() => {
        ...
        public void Enumerate_6_Test() {
            var ints = Tuple.Create(1, 2, 3, 4, 5, 6).Enumerate().ToArray();
            CollectionAssert.AreEqual(new[] { 1, 2, 3, 4, 5, 6 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4", "5", "6").Enumerate().ToArray();
            CollectionAssert.AreEqual(new[] { "1", "2", "3", "4", "5", "6" }, strings);
            Assert.ThrowsException<ArgumentNullException>(() => {
        ...
        public void Enumerate_7_Test() {
            var ints = Tuple.Create(1, 2, 3, 4, 5, 6, 7).Enumerate().ToArray();
            CollectionAssert.AreEqual(new[] { 1, 2, 3, 4, 5, 6, 7 }, ints);
            var strings = Tuple.Create("1", "2", "3", "4", "5", "6", "7").Enumerate().ToArray();
            CollectionAssert.AreEqual(new[] { "1", "2", "3", "4", "5", "6", "7" }, strings);
            Assert.ThrowsException<ArgumentNullException>(() => {
